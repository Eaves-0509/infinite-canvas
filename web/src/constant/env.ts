...
export const EAVES_API_URL = import.meta.env.VITE_EAVES_API_URL || "https://ai.eaves.chat/";
export const DOCS_URL = import.meta.env.VITE_DOC_URL || "https://doc-hb.eaves.chat/";
