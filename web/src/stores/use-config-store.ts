...
export type ApiCallFormat = "openai" | "gemini" | "grok" | "custom";
...
export function defaultBaseUrlForApiFormat(apiFormat: ApiCallFormat) {
    ...
    return apiFormat === "custom" ? "" : OPENAI_BASE_URL;
}

function normalizeApiFormat(apiFormat: unknown): ApiCallFormat {
    return apiFormat === "gemini" || apiFormat === "grok" || apiFormat === "custom" ? apiFormat : "openai";
}
